...
result = redback.result.read_in_result('/home/wfw23/Mphys_proj/GRBData/afterglow/flux_density/extinction_with_afterglow_base_model/GRBagdominates_on_result.json')

kwargs = dict(frequency=result.meta_data['frequency'], output_format='flux_density')
...
new_result= rw(result, label='rw_agdominates_on', new_likelihood=new_likelihood)
new_result.save_to_file('rw_agdominates_on.json')
